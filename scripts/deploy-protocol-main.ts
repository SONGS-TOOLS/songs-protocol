...
async function main() {
  ...
  // base SONGS NFT CONTRACT
  await whitelistingManager.setNFTContract("0x4298a1f67b54818cd72f7980c467c72561d9c3c3");
  await whitelistingManager.toggleNFTRequirement(false);
