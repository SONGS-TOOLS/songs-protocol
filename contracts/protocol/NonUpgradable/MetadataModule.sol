...
contract MetadataModule is Ownable {
  ...
  function createMetadata(
    ...
    require(
      bytes(wrappedSongMetadata[wrappedSong].name).length == 0,
  ...
  function requestUpdateMetadata(
    ...
    require(
      protocolModule.isReleased(wrappedSong),
  ...
  function updateMetadata(
    ...
    require(
      !protocolModule.isReleased(wrappedSong),
      'Cannot update metadata directly after release'
    );
  ...
  function confirmUpdateMetadata(address wrappedSong) external {
    ...
    require(
      !metadataUpdateConfirmed[wrappedSong],
   ...
   */
  function isMetadataUpdateConfirmed(
    address wrappedSong
