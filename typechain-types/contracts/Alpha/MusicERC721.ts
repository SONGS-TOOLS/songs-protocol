...
export interface MusicERC721Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface MusicERC721 extends BaseContract {
  connect(runner?: ContractRunner | null): MusicERC721;
  waitForDeployment(): Promise<this>;

  interface: MusicERC721Interface;
  ...
  setTokenUri: TypedContractMethod<[metadataURI: string], [void], "nonpayable">;
