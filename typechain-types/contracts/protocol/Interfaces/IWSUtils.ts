...
export interface IWSUtilsInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface IWSUtils extends BaseContract {
  connect(runner?: ContractRunner | null): IWSUtils;
  waitForDeployment(): Promise<this>;

  interface: IWSUtilsInterface;
