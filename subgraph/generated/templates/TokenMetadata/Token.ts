...
export class Token__createsWrappedSongTokensResult {
  value0: BigInt;
  value1: BigInt;
...
export class Token__sharesForSaleResult {
  value0: BigInt;
  value1: BigInt;
...
export class Token extends ethereum.SmartContract {
  ...
  createsWrappedSongTokens(
    ...
    sharesURI: string,
    creator: Address,
  ): Token__createsWrappedSongTokensResult {
    let result = super.call(
      "createsWrappedSongTokens",
    ...
    return new Token__createsWrappedSongTokensResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }
  ...
  try_createsWrappedSongTokens(
    ...
    sharesURI: string,
    creator: Address,
  ): ethereum.CallResult<Token__createsWrappedSongTokensResult> {
    let result = super.tryCall(
      "createsWrappedSongTokens",
      "createsWrappedSongTokens(string,uint256,string,address):(uint256,uint256)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new Token__createsWrappedSongTokensResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
      ),
    );
  ...
  sharesForSale(param0: BigInt): Token__sharesForSaleResult {
    let result = super.call(
      "sharesForSale",
    ...
    return new Token__sharesForSaleResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }
  ...
  try_sharesForSale(
    param0: BigInt,
  ): ethereum.CallResult<Token__sharesForSaleResult> {
    let result = super.tryCall(
      "sharesForSale",
      "sharesForSale(uint256):(uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Token__sharesForSaleResult(value[0].toBigInt(), value[1].toBigInt()),
    );
  }
