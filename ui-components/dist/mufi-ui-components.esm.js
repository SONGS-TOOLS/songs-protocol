...
import React__default, { useState, useMemo, createElement, useEffect, useRef, useCallback } from 'react';
...
var CenteredIcon = /*#__PURE__*/styled.div(_templateObject || (_templateObject = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n\tdisplay: flex;\n\talign-items: center;\n\tjustify-content: center;\n\theight: 100%;\n\twidth: 100%;\n\tsvg {\n\t\theight: 100%;\n\t\twidth: 100%;\n\t\tfill: ", ";\n\t}\n"])), function (props) {
...
var AddressDisplay = function AddressDisplay(_ref) {
  var address = _ref.address,
    ...
    className = _ref.className;
  var displayAddress = useMemo(function () {
    return ensName != null ? ensName : shortenHash(utils.getAddress(address));
  }, [address, ensName]);
...
var gradientStyles = /*#__PURE__*/css(_templateObject$1 || (_templateObject$1 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n  ", "\n"])), function (_ref) {
...
var StyledButton = /*#__PURE__*/styled.button(_templateObject2 || (_templateObject2 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  width: fit-content;\n  border-radius: 9999px; /* rounded-full */\n  gap: 0.5rem; /* gap-2 */\n  transition: all 0.2s;\n  position: relative;\n  padding: ", "px;\n  background: ", ";\n  background-clip: padding-box;\n  border: solid ", "px transparent;\n  ", "\n  ", "\n  ", "\n  ", "\n"])), function (_ref2) {
...
var WalletInput = /*#__PURE__*/React__default.forwardRef(function (_ref, ref) {
  ...
  var wasNotEditingRef = useRef(true);
  ...
  var fullValue = useMemo(function () {
  ...
  */
  // Show ens or address
  var toggleDisplayMode = useCallback(
  ...
  */
  var setValue = useCallback(function (addressOrEns) {
  ...
  */
  var DisplayModeToggle = useMemo(function () {
...
var useScreen = function useScreen() {
  var _useState = useState(reportScreen()),
    screen = _useState[0],
...
var DropInput = function DropInput(_ref2) {
  ...
  var _useDropzone = useDropzone(_extends({}, dropzoneConfig)),
    dropzoneAcceptedFiles = _useDropzone.acceptedFiles,
    getRootProps = _useDropzone.getRootProps,
    getInputProps = _useDropzone.getInputProps;
  var acceptedFilesCombined = useMemo(function () {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 10:
            address = _context.t1;
            setIsLoading(false);
            return _context.abrupt("return", (_ethers$utils$getAddr = ethers.utils.getAddress(address)) != null ? _ethers$utils$getAddr : null);
          case 15:
            _context.prev = 15;
...
var ModalContainer = function ModalContainer(_ref) {
  ...
  var _useScreen = useScreen(),
    screen = _useScreen.screen;
  var contentAnimation = useMemo(function () {
  ...
  return /*#__PURE__*/React__default.createElement(motion.div, Object.assign({
    key: "modal-container"
  }, contentAnimation, {
    transition: {
      duration: 0.2
...
var Modal = function Modal(_ref2) {
  ...
  return /*#__PURE__*/React__default.createElement(Root, {
    open: rootOpen
  }, /*#__PURE__*/React__default.createElement(Portal, null, /*#__PURE__*/React__default.createElement(AnimatePresence, null, isOpen && ( /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(ModalOverlay, null), /*#__PURE__*/React__default.createElement(Content, {
...
var Step = function Step(props) {
  ...
  }, stepInfo.title)), screen === ScreenType.Mobile && index === stepIndex ? ( /*#__PURE__*/React__default.createElement(motion.div, {
    initial: {
      opacity: 0
    },
    animate: {
...
var SvgWarnDocument = function SvgWarnDocument(props) {
  return /*#__PURE__*/createElement("svg", _extends$F({
    ...
    rx: 6
  }))), _g2 || (_g2 = /*#__PURE__*/createElement("g", {
  ...
  })), /*#__PURE__*/createElement("pattern", {
...
export { AccountLabel, ActionContainer, ActionIconLabel, ActionLabel, AddressDisplay, AddressInput, SvgAgreement as AgreementIcon, SvgAgreementsHeader as AgreementsHeader, SvgAlert as AlertIcon, AnimationLoader, Body1, Body2, Body3, BodyHeadline, ProgressSteps as Breadcrumbs, Button, Card, SvgCheck as CheckIcon, SvgClock as ClockIcon, SvgCollateral as CollateralIcon, SvgConstitution as ConstitutionIcon, SvgCreation as CreationIcon, SvgCross as CrossIcon, CustomRadioInput, SvgDashboard as DashboardIcon, SvgDispute as DisputeIcon, SvgDown as DownIcon, DropInput, SvgDropdown as DropdownIcon, SvgFileAdd as FileAddIcon, SvgFileEncrypted as FileEncryptedIcon, SvgFilePending as FilePendingIcon, SvgFilter as FilterIcon, SvgFingerpint as FingerprintIcon, Footer, SvgFullOrb as FullOrbIcon, GradientBorderButton, GridContainer, Handler, Headline1, Headline2, Headline3, Headline4, HeadlineBasic, IconButton, IconLabel, IconRenderer, IllustrationRenderer, SvgInfo as InfoIcon, SvgJudge as JudgeIcon, Label, SvgLeft as LeftIcon, SvgLess as LessIcon, Loading, SvgManifesto as ManifestoIcon, Modal, ModalContainer, ModalOverlay, SvgN3 as N3Icon, SvgOrbitingOrbGreen as OrbitingOrbGreen, SvgPaper as PaperIcon, PasswordInput, SvgPlay as PlayIcon, SvgPlus as PlusIcon, SvgPrivate as PrivateIcon, SvgResolution as ResolutionIcon, SvgRight as RightIcon, RoundedHandler, SvgSignal as SignalIcon, Spinner, Steps, Table, TextAreaInput, TextInput, SvgTheme as ThemeIcon, ThemedIconRenderer, SvgToken as TokenIcon, SvgUnlock as UnlockIcon, SvgUp as UpIcon, SvgUser as UserIcon, WalletInput, SvgWarnDocument as WarnDocumentOrange, SvgWorld as WorldIcon, SvgZoom as ZoomIcon, useScreen, index as utils };
//# sourceMappingURL=mufi-ui-components.esm.js.map
