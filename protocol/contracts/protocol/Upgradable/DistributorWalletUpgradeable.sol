...
contract DistributorWalletUpgradeable is Initializable, UUPSUpgradeable, OwnableUpgradeable {
  ...
  function redeem(address _wrappedSong) external {
    require(msg.sender == OwnableUpgradeable(_wrappedSong).owner(), "Only wrapped song owner can redeem");
